  ...
  return (
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        ...
        {/* Test Content: Replace Card with a simple div */}
        <div className="mb-8 inline-block w-full p-6 md:p-8">
        ...
        {/* Repeat for the rest of the testimonials, replacing Card with div */}
        <div className="mb-8 inline-block w-full p-6 md:p-8">
          <div className="mb-5 flex md:mb-6">
            <BiSolidStar className="mr-1 size-6" />
            <BiSolidStar className="mr-1 size-6" />
          ...
          <blockquote className="md:text-md">
            "Grabbl has transformed my late-night snack runs! The app is super
      ...
      <div className="mb-8 inline-block w-full p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "I love how quickly I can get my favorite drinks delivered! Grabbl
                    is my go-to app for convenience and savings."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-fit md:flex-row md:items-center">
                    <img
                      src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
